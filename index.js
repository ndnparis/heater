...
function awsCredentialsRefresh(getUsername) {
  ...
  //AWS.config.region = heaterVars.regionCognito;
...
console.log('Apres EV_SIGNED_IN');

          eventHandler(EV_SIGN_DONE);
console.log('Apres EV_SIGN_DONE');
